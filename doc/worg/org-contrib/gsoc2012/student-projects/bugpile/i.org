...
| *alternative flow* | --                             |
| *postcondition*    | user sees a (possibly empty) result list |
...
| *precondition*     | admin or assignee logged in, task exists |
...
*** Associate related tasks
    :PROPERTIES:
    :CUSTOM_ID: assoc-rel-tasks-txt
    :END: 

|                    | <30>                           |
| *use case*         | associate related tasks        |
| *actors*           | admin or assignee              |
| *precondition*     | --                             |
| *main flow*        | admin or assignee searches the tasklist, selects at least two related tasks and takes action 'associate related tasks' on them |
| *alternative flow* | --                             |
| *postcondition*    | tasks flagged as related       |

*** Dissociate related tasks
    :PROPERTIES:
    :CUSTOM_ID: dissoc-rel-tasks-txt
    :END: 

|                    | <30>                           |
| *use case*         | dissociate related tasks       |
| *actors*           | admin or assignee              |
| *precondition*     | selected tasks are flagged as related |
| *main flow*        | admin or assignee searches the tasklist, selects at least two tasks that are flagged as related, and takes action 'dissociate related tasks' on them |
| *alternative flow* | --                             |
| *postcondition*    | selected tasks not flagged as related anymore |
...
*** Associate related tasks
    :PROPERTIES:
    :CUSTOM_ID: assoc-rel-tasks-uml-roa
    :END: 
...
*** Dissociate related tasks
    :PROPERTIES:
    :CUSTOM_ID: dissoc-rel-tasks-uml-roa
    :END: 
